...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-lg-8 col-sm-12">
            @if (Auth::check())
            <small><a href="{{ url('daily') }}">管理画面</a> <i class="bi bi-chevron-right"></i> 部署追加</small>
            <h4 class="fw-bold mt-2">部署追加</h4>
            ...
            <div class="bg-white p-5 mt-4" id="formarea">
                ...
                <nav>
                  ...
                  <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="row mt-5">
                        <div class="col-8">
                            <a type="button" class="btn btn-dark btn-sm" href="{{ url('/template_create') }}"><i class="bi bi-plus-square"></i> 部署追加</a>
                        </div>
                        <div class="col-4 text-end">
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm" placeholder="検索" aria-label="Example input with button-sm addon">
